...
public class HelloProxy implements com.lti.services.Hello {
  private String _endpoint = null;
  private com.lti.services.Hello hello = null;
  ...
  private void _initHelloProxy() {
    try {
      hello = (new com.lti.services.HelloServiceLocator()).getHello();
      if (hello != null) {
        if (_endpoint != null)
  ...
  public com.lti.services.Hello getHello() {
    if (hello == null)
      _initHelloProxy();
    return hello;
  }
